...
import { changeFailureRateName, changeLeadTimeName, deploymentFrequencyName, recoverTimeName } from '../src/constants'
import './general.css'
  ...
  return (
    <div className="graphContainer">
      <EditPanel args={graphArgs} showStandardFields>
        ...
        <MetricEditor metricName={changeFailureRateName} metricThresholds={graphArgs.metricThresholdSet.changeFailureRate!} onChange={graphArgs.changeThreshold} />
        ...
        <div>
          ...
          <input type='checkbox' checked={hideColors} onChange={changeHideColors} />
        </div>
        <div>
          <label>Show Trends:</label>
          <input type='checkbox' checked={showTrends} onChange={changeShowTrends} />
        </div>
        <div>
          <label>Always Show Details:</label>
          <input type='checkbox' checked={alwaysShowDetails} onChange={changeAlwaysShowDetails} />
        </div>
      </EditPanel>
      <Board hideColors={hideColors} alwaysShowDetails={alwaysShowDetails} showTrends={showTrends} metricThresholdSet={graphArgs.metricThresholdSet} includeWeekendsInCalculations={graphArgs.includeWeekends} graphStart={graphArgs.graphStart} graphEnd={graphArgs.graphEnd} loading={graphArgs.loading} message={graphArgs.message} data={graphArgs.data} holidays={graphArgs.holidays} />
    </div>
  )
}
