  ...
  return (
    <>
      ...
      <div>
        <label>Elite:</label>&nbsp;
        <input
          className="editorMetricInput"
          min={0}
          type="number"
          value={props.metricThresholds!.elite!}
          onChange={props.onChange}
          data-metric={props.metricName}
          data-rank="elite"
        />
        <span> {props.postFix ? props.postFix : 'hrs'}</span>
        <br />
        <label>High:</label>&nbsp;
        <input
          className="editorMetricInput"
          min={0}
          type="number"
          value={props.metricThresholds!.high!}
          onChange={props.onChange}
          data-metric={props.metricName}
          data-rank="high"
        />
        ...
        <input
          ...
          min={0}
          type="number"
          value={props.metricThresholds!.medium!}
          onChange={props.onChange}
          data-metric={props.metricName}
          data-rank="medium"
        />
